          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _api_project__WEBPACK_IMPORTED_MODULE_2__["default"].allProjects({
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return _api_project__WEBPACK_IMPORTED_MODULE_2__["default"].deleteProject(data);
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("header", { staticClass: "py-4" }, [
      _c("div", { staticClass: "flex items-end justify-between" }, [
        ...
        _c(
          "a",
          { staticClass: "button", attrs: { href: "/projects/create" } },
          [_vm._v("New Project")]
        )
      ])
    ])
...
var ProjectEndpoints = {
  ...
  allProjects: function () {
    var _allProjects = _asyncToGenerator(
    /*#__PURE__*/
    ...
    function allProjects(_x) {
      return _allProjects.apply(this, arguments);
    }
